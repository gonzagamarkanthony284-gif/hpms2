...
/**
 * Database-backed implementation of DoctorService used by the UI.
...
public class DoctorServiceImpl implements DoctorService {
    ...
    private static final class Holder {
        static final DoctorServiceImpl INSTANCE = new DoctorServiceImpl();
    }
    ...
    public DoctorServiceImpl() {
        this.repo = DoctorRepository.getInstance();
    }
    ...
    public Doctor findById(int id) {
        // compatibility: Doctor.getDoctorId is a String; this interface used int ->
        // return null
        return null;
    }

    public Optional<Doctor> findByDoctorId(String id) {
    ...
    public java.util.List<Doctor> listActive() {
        return repo.findAll().stream().filter(d -> d.getStatus() != null && d.getStatus().name().equals("ACTIVE"))
